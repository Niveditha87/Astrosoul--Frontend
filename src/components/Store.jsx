  ...
  return (
      ...
      <div className='container mx-auto'>
          <div className=" flex flex-wrap items-start justify-center ">
              ...
              {data && data.map(data => (
                  <div key={data._id} className="flex items-center justify-center  w-full md:w-1/3 lg:w-1/4  mb-5 lg:pl-2 lg:pr-2 mt-5 ">
                      <div className="bg-white rounded-lg m-h-64  transform hover:translate-y-2 hover:shadow-xl transition duration-300 w-full shadow-sm shadow-gray-500 hover:bg-orange-100">
          ...
          <div className='flex justify-center  p-1 mt-5 '>
              ...
              <h1 className='h-10 mt-2  text-xl font-bold  text-orange-600 '>
                  View More
              </h1>
          </div>
