...
function KundaliHoroscope() {
  return (
    <div className="w-ful flex justify-center gap-11 m-10">
      <div>
      ...
      <div>
        ...
        <div><AiOutlineShareAlt size={20}/></div>
        </div>
        <div>
        ...
        <div className="flex gap-7">
            <div className="block">
           <div><label className="font-bold">Languages:</label></div> 
        <select name="languages" id="cars" className="border rounded-md w-[300px]">
  ...
  <div className="block">
           <div><label className="font-bold">chartstyle:</label></div> 
        <select name="languages" id="cars" className="border rounded-md w-[300px]">
    ...
    <option value="audi">West</option>
        ...
        <br/>
        <hr/>
        <div className="flex border shadow-lg m-2 w-80 gap-8 p-2">
            <div>
            <div className="flex gap-8">
                <div className="text-sm font-semibold">Ajaychaubey</div>
                <div className="flex text-blue-900 items-center border border-blue-500 rounded-md px-3"><BiEdit color={"blue"}/>Edit</div>
            <div className="flex items-center border text-blue-900 border-blue-500 rounded-md px-3"><BsCardList color={"blue"}/>List</div>
            </div>
            <div>
            <div className="flex items-center gap-1"><GiMale/>Male|Single</div>
            </div>
            <div className="flex">
                <div className="flex items-center gap-1"><BsFillCalendarDateFill/>08/10/2022|</div>
                <div className="flex items-center gap-1"><BiTime/>06:30:00 AM</div>
            </div>
            <div className="flex items-center gap-1"><CiLocationOn/>Bangalore,Karnataka</div>
